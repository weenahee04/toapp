...
use App\Events\SupportChat\DeleteMessage;
...
class SupportTicketController extends Controller
{
    ...
    public function ticketDelete($id)
    {
        ...
        broadcast(new DeleteMessage($message->support_ticket_id,$message))->toOthers();
        $message->delete();
        $notify = ['success', "Support ticket deleted successfully"];
        return ["message_id"=>$message->id,'notify'=>$notify];
