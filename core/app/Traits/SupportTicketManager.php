...
use App\Events\SupportChat\Message;
use Carbon\Carbon;
...
trait SupportTicketManager
{
    ...
    public function replyTicket(Request $request, $id)
    {
        ...
        broadcast(new Message($ticket->id,$message))->toOthers();
        $notify[] = ['success', 'Support ticket replied successfully!'];
        return ['message'=>$message,'notify'=>$notify];
    }
    ...
    public function message(Request $request){
        ...
        $message = SupportMessage::where('id', $request->message['id'])->with('ticket', 'admin', 'attachments')->orderBy('id', 'desc')->first();
     
        if($message){
            $ticket = $message->ticket;
        if($ticket->user_id==auth()->user()->id){
            return view('Template::user.support.message', compact('message'));
        }
    ...
    public function supportMessage(Request $request){
        ...
        if($message){
            ...
            $ticket = $message->ticket;
            if(auth('admin')->user()){
                return view('admin.support.message', compact('message','ticket'));
            }
        }
