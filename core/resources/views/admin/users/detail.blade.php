    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="d-flex flex-wrap gap-3 mt-4">
                ...
                <div class="flex-fill">
                    <a href="{{route('admin.users.investment',$user->id)}}" class="btn btn--success btn--shadow w-100 btn-lg">
                        <i class="las la-hand-holding-usd"></i>@lang('Investments')
                    </a>
                </div>
                <div class="flex-fill">
                    <a href="{{route('admin.users.referrals',$user->id)}}" class="btn btn--primary  btn--shadow w-100 btn-lg">
                        <i class="las la-user-friends"></i> @lang('Referrals')
                    </a>
                </div>
