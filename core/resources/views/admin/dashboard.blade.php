    ...
    <div class="row mt-2 gy-4">
        ...
        <div class="col-xxl-4 col-sm-6">
            ...
            <x-widget
                style="7"
                type="2"
                link="{{ route('admin.report.investments') }}?status={{ Status::RUNNING }}"
                icon="la la-funnel-dollar"
                title="Running Investments"
                value="{{ $widget['running_investments'] }}"
                bg="warning"
            />
        </div><!-- dashboard-w1 end -->
        ...
        <div class="col-xxl-4 col-sm-6">
            ...
            <x-widget
                style="7"
                type="2"
                link="{{ route('admin.report.investments') }}?status={{ Status::COMPLETED }}"
                icon="las la-coins"
                title="Complated Investments"
                value="{{ $widget['completed_investments'] }}"
                bg="success"
            />
        </div><!-- dashboard-w1 end -->
